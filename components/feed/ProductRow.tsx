      ...
      >
        {products.map((product) => (
          <button
            ...
            className="flex-shrink-0 flex items-center gap-2.5 bg-bg/80 backdrop-blur-md border border-white/10 rounded-xl px-3 py-2.5 text-left transition-transform active:scale-95"
          >
            {product.imageUrl && (
              <img
            ...
            <div className="min-w-0 max-w-[140px]">
              ...
              {product.brand && (
                <p className="text-[11px] text-muted truncate">{product.brand}</p>
              )}
