...
const benefits = [
  {
    title: "Let creators sell for you",
    description: "Creators tag your products in their videos. You get authentic promotion without the overhead.",
    icon: (
  ...
  },
  {
    ...
    description: "Track which products perform, which creators drive sales, and your revenue in real time.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "No listing fees, no subscription. You only pay a small commission when a sale is made.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Connect your Shopify store and sync products automatically. No manual uploads needed.",
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
          ...
          <div>
            <ScrollReveal>
              ...
              <h2 className="text-4xl sm:text-5xl font-display font-bold text-warm-text leading-tight mb-6">
                Your products, powered by creators.
              </h2>
              <p className="text-lg text-warm-secondary leading-relaxed mb-10">
                List your store on Scrollr and let creators showcase your products in authentic video content. You focus on fulfillment — they handle the selling.
              </p>
            </ScrollReveal>
