...
const steps = [
  {
    ...
    description: "Watch short videos from creators who share your style. Every product you see is real and in stock.",
    icon: (
  ...
  },
  {
    ...
    description: "See something you love? Tap the product tag. View sizes, prices, and reviews — without leaving the video.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  },
  {
    ...
    description: "Add to cart, checkout with Stripe. Your order ships directly from the brand. No middleman, no redirects.",
    icon: (
      <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
